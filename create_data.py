...
for smile in compound_iso_smiles:
    ...
    seq = smiles_to_sequence(smile)
    smile_sequence[smile] = seq
...
for dataset in datasets:
    ...
    if ((not os.path.isfile(processed_data_file_train)) or (not os.path.isfile(processed_data_file_test))):
        ...
        # Process test set
        test_drugs, test_MTS, test_prots, test_Y = list(df_test['compound_iso_smiles']), list(df_test['target_smiles']), list(df_test['target_sequence']), list(df_test['affinity'])
        ...
        train_data = TestbedDataset(root='data', dataset=dataset+'_train', xd=train_drugs, xdt=train_XD, xt=train_prots, y=train_Y, smile_graph=smile_graph, smile_sequences=smile_sequence)
        
        print('preparing ', dataset + '_test.pt in pytorch format!')
        test_data = TestbedDataset(root='data', dataset=dataset+'_test', xd=test_drugs, xdt=test_XD, xt=test_prots, y=test_Y, smile_graph=smile_graph, smile_sequences=smile_sequence)
